    ...
    def _set_sequence(self):
        ...
        for i in range(self.num_styles - 1):
            ...
            if self.style_indexes[i] is not None and self.style_indexes[i + 1] is not None:
                ...
                elif self.style_indexes[i] != self.begFrame and self.style_indexes[i + 1] != self.endFrame and \
                        self.style_indexes[i] in self.imgindexes and self.style_indexes[i + 1] in self.imgindexes:
                    sequences.append(Sequence(
